...
namespace Gdr2333.BotLib.OnebotV11.Messages.Parts.Base;
...
public abstract class FilePartBase : MessagePartBase
{
    ...
    /// </summary>
    [JsonConstructor]
    protected FilePartBase(string type) : base(type)
    {
        FileName = "";
    }
    ...
    public FilePartBase(string type, string fileName, bool useCache = StaticData.CqUseCahceDefault, bool useProxy = StaticData.CqUseProxyDefault, TimeSpan? timeOut = null) : base(type)
    {
        FileName = fileName;
        UseProxy = useProxy;
        UseCache = useCache;
